...
public class KafkaProducerApplication {
    ...
    public KafkaProducerApplication(final Producer<String, String> producer,    // pass Producer instance
                                    final String topic) {                       // pass topic name
    ...
    public Future<RecordMetadata> produce(final String message) {
        ...
        // Generate the constant ProducerRecord instance for pushing to the topic
        final ProducerRecord<String, String> producerRecord = new ProducerRecord<>(outTopic, key, value);
        // .send() is *async* and returns when the record is placed in the buffer
        return producer.send(producerRecord);
        // the broker will ack the record and application receives a RecordMetadata instance
        // NOTE: calling Future.get() will block until the record is acked
    }
